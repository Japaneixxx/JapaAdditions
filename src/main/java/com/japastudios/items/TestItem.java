...
public class TestItem extends PickaxeItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> list, TooltipFlag flag) {
        ...
        list.add(new TranslatableComponent("message.testitem.tooltip", Integer.toString(distance)).withStyle(ChatFormatting.DARK_PURPLE));
    }
    ...
    public int getDistance(ItemStack stack) { return stack.hasTag() ? stack.getTag().getInt("distance") : 0; }
    ...
    private BlockHitResult trace(Level level, LivingEntity player) {
        ...
        Vec3 witReach = eye.add(view.x * reach, view.y * reach, view.z * reach);
        return level.clip(new ClipContext(eye, witReach, ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, player));
    }
